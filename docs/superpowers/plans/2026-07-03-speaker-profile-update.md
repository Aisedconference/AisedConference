...
**Goal:** Expand the local speaker profile to four consistently formatted cards and shorten three committee organisation labels to `(AeU-SPEED)`.
...
Preserve the three job titles and replace only their organisation suffix with `(AeU-SPEED)`.
